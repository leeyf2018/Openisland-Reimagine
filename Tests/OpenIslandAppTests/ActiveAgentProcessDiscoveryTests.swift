...
struct ActiveAgentProcessDiscoveryTests {
    ...
    @Test
    func discoverMergesRegistryAndLsofBoundGrokOrphanWithoutDuplicates() {
        let registeredID = "019fc6fa-5c3f-7631-89b0-d260b8ad1739"
        let orphanID = "019fc5e3-a1de-7792-9384-913e2045c491"
        let staleRegisteredID = "019fc649-fffe-7ed3-be09-756864cc8703"
        let discovery = ActiveAgentProcessDiscovery(
            commandRunner: { executablePath, arguments in
                if executablePath == "/bin/ps" {
                    return """
                      699 301 ttys001 /Users/test/.grok/bin/grok
                      94175 302 ttys002 /Users/test/.grok/bin/grok
                      94176 94175 ttys002 /Users/test/.grok/bin/grok
                ...
                case "94175", "94176":
                    ...
                    fcwd
                    n/tmp/project
                    n/Users/test/.grok/sessions/%2Ftmp%2Fproject/\(orphanID)/events.jsonl
                    """
                default:
                    return nil
                }
        ...
        let grokSnapshots = discovery.discover().filter { $0.tool == .grok }

        #expect(grokSnapshots.count == 2)
        #expect(Set(grokSnapshots.compactMap(\.sessionID)) == Set([registeredID, orphanID]))
        #expect(grokSnapshots.allSatisfy { $0.terminalApp == "Ghostty" })
    }
}
